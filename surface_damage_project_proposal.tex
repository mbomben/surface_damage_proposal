...
\begin{enumerate}[a)]
\item  first with X-rays or 
\item $\gamma-$rays and then with 
...
\end{enumerate}
\item Analyse the results to extract fundamental parameters like
\begin{enumerate}[a)] 
\item a minimal set of effective bulk defects
\item a minimal set of effective surface defects
\end{enumerate}
...
\item $^{60}$Co source ({\it needed? Availability?})
...
$1\times10^{15}$, $3\times10^{15}$, $1\times10^{16}$ and $2\times10^{16}\,{\rm n_{eq}/cm^2}$.
\end{itemize}
